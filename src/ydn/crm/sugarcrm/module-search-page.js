...
goog.provide('ydn.crm.su.ui.ModuleSearchPage');
 ...
 * @deprecated use ydn.crm.su.ui.ModulePage
 */
ydn.crm.su.ui.ModuleSearchPage = function(sugar, name, opt_dom) {
...
goog.inherits(ydn.crm.su.ui.ModuleSearchPage, goog.ui.Component);
 ...
 * @override
 */
ydn.crm.su.ui.ModuleSearchPage.prototype.getModel;
 ...
 * @type {string}
 */
ydn.crm.su.ui.ModuleSearchPage.CSS_CLASS_LIST = 'module-page-list';


/**
 * @inheritDoc
 */
ydn.crm.su.ui.ModuleSearchPage.prototype.getContentElement = function() {
 ...
 * @enum {string}
 */
ydn.crm.su.ui.ModuleSearchPage.Filter = {
  ALL: 'filter-all',
  MY: 'filter-my',
  FAVORITE: 'filter-fav',
  CACHE: 'filter-cache'
 ...
 * @enum {string}
 */
ydn.crm.su.ui.ModuleSearchPage.Order = {
  ID: 'order-id',
  RECENT: 'order-rc',
  NAME: 'order-na'
};
...
ydn.crm.su.ui.ModuleSearchPage.prototype.getFilter = function() {
  for (var i = 0, n = this.menu_.getChildCount(); i < n; i++) {
    ...
    if (name == ydn.crm.su.ui.ModuleSearchPage.Filter.ALL) {
      return ydn.crm.su.ui.ModuleSearchPage.Filter.ALL;
    } else if (name == ydn.crm.su.ui.ModuleSearchPage.Filter.MY) {
      return ydn.crm.su.ui.ModuleSearchPage.Filter.MY;
    } else if (name == ydn.crm.su.ui.ModuleSearchPage.Filter.FAVORITE) {
      return ydn.crm.su.ui.ModuleSearchPage.Filter.FAVORITE;
    } else if (name == ydn.crm.su.ui.ModuleSearchPage.Filter.CACHE) {
      return ydn.crm.su.ui.ModuleSearchPage.Filter.CACHE;
    }
  }
  return ydn.crm.su.ui.ModuleSearchPage.Filter.ALL;
};
...
/**
 * Set active filter.
 * @param {ydn.crm.su.ui.ModuleSearchPage.Filter} filter
 */
ydn.crm.su.ui.ModuleSearchPage.prototype.setFilter = function(filter) {
  for (var i = 0, n = this.menu_.getChildCount(); i < n; i++) {
    var child = /** @type {goog.ui.Control} */(this.menu_.getChildAt(i));
...
/**
 * Set sort order.
 * @param {ydn.crm.su.ui.ModuleSearchPage.Order} order
 */
ydn.crm.su.ui.ModuleSearchPage.prototype.setOrder = function(order) {
  for (var i = 0, n = this.menu_.getChildCount(); i < n; i++) {
    var child = /** @type {goog.ui.Control} */(this.menu_.getChildAt(i));
    if (!(child instanceof goog.ui.Control)) {
      continue;
 ...
 * @return {ydn.crm.su.ui.ModuleSearchPage.Order} active sort order.
 */
ydn.crm.su.ui.ModuleSearchPage.prototype.getSortOrder = function() {
  for (var i = 0, n = this.menu_.getChildCount(); i < n; i++) {
    var child = /** @type {goog.ui.Control} */(this.menu_.getChildAt(i));
    if (!(child instanceof goog.ui.Control) || !child.isChecked()) {
      continue;
    ...
    var name = child.getModel() || '';
    if (name == ydn.crm.su.ui.ModuleSearchPage.Order.ID) {
      return ydn.crm.su.ui.ModuleSearchPage.Order.ID;
    } else if (name == ydn.crm.su.ui.ModuleSearchPage.Order.NAME) {
      return ydn.crm.su.ui.ModuleSearchPage.Order.NAME;
    } else if (name == ydn.crm.su.ui.ModuleSearchPage.Order.RECENT) {
      return ydn.crm.su.ui.ModuleSearchPage.Order.RECENT;
    }
  }
  return ydn.crm.su.ui.ModuleSearchPage.Order.ID;
};
 ...
 * @inheritDoc
 */
ydn.crm.su.ui.ModuleSearchPage.prototype.createDom = function() {
  ...
  var ul = dom.createDom('ul', ydn.crm.su.ui.ModuleSearchPage.CSS_CLASS_LIST);
 ...
 */
ydn.crm.su.ui.ModuleSearchPage.prototype.getSearchCtrl = function() {
 ...
 * @private
 */
ydn.crm.su.ui.ModuleSearchPage.prototype.addResult_ = function(arr) {
 ...
 * @private
 */
ydn.crm.su.ui.ModuleSearchPage.prototype.refresh_ = function() {
 ...
 * @private
 */
ydn.crm.su.ui.ModuleSearchPage.prototype.updateSearchLabel_ = function() {
  var label = 'Search';
  var filter = this.getFilter();
  if (filter == ydn.crm.su.ui.ModuleSearchPage.Filter.ALL) {
    label += ' All';
  } else if (filter == ydn.crm.su.ui.ModuleSearchPage.Filter.MY) {
    label += ' My';
  } else if (filter == ydn.crm.su.ui.ModuleSearchPage.Filter.FAVORITE) {
    label += ' Favorite';
  } else if (filter == ydn.crm.su.ui.ModuleSearchPage.Filter.CACHE) {
    label += ' Offline';
  }
  label += ' ' + this.name;
 ...
 * @inheritDoc
 */
ydn.crm.su.ui.ModuleSearchPage.prototype.enterDocument = function() {
 ...
 * @private
 */
ydn.crm.su.ui.ModuleSearchPage.prototype.onTileClick_ = function(ev) {
 ...
 * @private
 */
ydn.crm.su.ui.ModuleSearchPage.prototype.onMenuAction_ = function(ev) {
  if (ev.target instanceof goog.ui.CheckBoxMenuItem) {
    ...
    if (goog.string.startsWith(name, 'filter-')) {
      this.setFilter(/** @type {ydn.crm.su.ui.ModuleSearchPage.Filter} */(name));
    } else if (goog.string.startsWith(name, 'order-')) {
      this.setOrder(/** @type {ydn.crm.su.ui.ModuleSearchPage.Order} */(name));
    }
  }
};
 ...
 * @type {string}
 */
ydn.crm.su.ui.ModuleSearchPage.NAME = 'Module';


/**
 * @inheritDoc
 */
ydn.crm.su.ui.ModuleSearchPage.prototype.toString = function() {
  return ydn.crm.su.ui.ModuleSearchPage.NAME;
};
