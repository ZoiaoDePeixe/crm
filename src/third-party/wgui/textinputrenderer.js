 ...
 * @return {Element} The DOM structure of TextInput.
 */
wgui.TextInputRenderer.prototype.buildTextInput = function(root, input, dom) {
  ...
  var clear_div = dom.createDom(
      'div', goog.getCssName(this.getCssClass(), 'clear'), '\u00D7'); // cross sign
  var outerBox = dom.createDom(
      'div', goog.getCssName(this.getCssClass(), 'outer-box'), [innerBox, clear_div]);
